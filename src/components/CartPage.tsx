              ...
              {cart.map(item => (
                ...
                >
                  ...
                  <div className="flex-1 w-full">
                    ...
                    <div className="font-bold text-white mb-1 pr-8 sm:pr-0 line-clamp-1">{item.product.name}</div>
                    <div className="text-sm font-bold text-[#E8EAF0]">${item.product.price.toLocaleString()}</div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end mt-2 sm:mt-0">
                    ...
                    <div className="text-right sm:hidden">
                      ...
                      <div className="text-sm font-bold text-white">${(item.product.price * item.qty).toLocaleString()}</div>
                    </div>
                  </div>
                </motion.div>
              ))}
